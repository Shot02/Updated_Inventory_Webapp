...
// Fix the setDateFilter function
function setDateFilter(filter) {
    ...
    const salesSearch = document.getElementById('salesSearchInput')?.value || '';
    const stockSearch = document.getElementById('stockSearchInput')?.value || '';
    
    // Update hidden search fields
    const salesSearchHidden = document.querySelector('input[name="sales_search"]');
    const stockSearchHidden = document.querySelector('input[name="stock_search"]');
    
    if (salesSearchHidden) salesSearchHidden.value = salesSearch;
    if (stockSearchHidden) stockSearchHidden.value = stockSearch;
